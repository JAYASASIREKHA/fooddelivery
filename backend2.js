...
app.get('/health', (req, res) => {
  res.json({ status: 'ok', service: 'backend2-service' });
});

app.listen(PORT, () => {
  console.log(`🔧 Backend 2 (Service Backend) running on http://localhost:${PORT}`);
  console.log(`✅ Ready to receive requests from Backend 1`);
});
